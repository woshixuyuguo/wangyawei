...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="icbcOrderController.do?doUpdate">
		...
		<tr>
			...
			<td class="value">
		     	 <input id="realAmount" name="realAmount" type="text" style="width: 150px" class="inputxt"  
					                ...
					                value='${icbcOrderPage.realAmount}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="provinceId" name="provinceId" type="text" style="width: 150px" class="inputxt"  
					                ...
					                value='${icbcOrderPage.provinceId}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="expressName" name="expressName" type="text" style="width: 150px" class="inputxt"  
					                ...
					                value='${icbcOrderPage.expressName}'>
				<span class="Validform_checktip"></span>
