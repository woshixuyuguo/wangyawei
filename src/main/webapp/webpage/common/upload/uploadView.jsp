...
<script type="text/javascript">
        ...
        function uploadSuccess(d,file,response){
                ...
                if(url.indexOf(".gif")!=-1 || 
                                ...
                                url.indexOf(".png")!=-1 ||
                                url.indexOf(".bmp")!=-1){
                        html += "<img src='cdActivityController.do?image&path="+url+"' width =400 height=300 />";
                }else{
                        html += "<a href='cdActivityController.do?image&path="+url+"' target=_blank >下载:"+d.attributes.name+"</a>";
                }
                $("#fileShow").html(html);
        }
