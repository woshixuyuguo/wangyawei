...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="cdCategoryController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="orderNumber" name="orderNumber" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${cdCategoryPage.orderNumber}'>
							<span class="Validform_checktip"></span>
