...
public class CdIcbcBaseController extends BaseController {
	...
	public void exportXls(CdIcbcBaseEntity cdIcbcBase,HttpServletRequest request,HttpServletResponse response
			, DataGrid dataGrid) {
		response.setContentType("application/vnd.ms-excel");
		String codedFileName = null;
		OutputStream fOut = null;
		try {
			codedFileName = "工商银行基础参数";
			// 根据浏览器进行转码，使其支持中文文件名
			...
			List<CdIcbcBaseEntity> cdIcbcBases = this.cdIcbcBaseService.getListByCriteriaQuery(cq,false);
			workbook = ExcelExportUtil.exportExcel(new ExcelTitle("工商银行基础参数列表", "导出人:"+ResourceUtil.getSessionUserName().getRealName(),
					"导出信息"), CdIcbcBaseEntity.class, cdIcbcBases);
	...
	public void exportXlsByT(CdIcbcBaseEntity cdIcbcBase,HttpServletRequest request,HttpServletResponse response
			, DataGrid dataGrid) {
		response.setContentType("application/vnd.ms-excel");
		String codedFileName = null;
		OutputStream fOut = null;
		try {
			...
			HSSFWorkbook workbook = null;
			workbook = ExcelExportUtil.exportExcel(new ExcelTitle("工商银行基础参数列表", "导出人:"+ResourceUtil.getSessionUserName().getRealName(),
					"导出信息"), CdIcbcBaseEntity.class, null);
			fOut = response.getOutputStream();
			workbook.write(fOut);
		} catch (Exception e) {
		} finally {
	...
	public AjaxJson importExcel(HttpServletRequest request, HttpServletResponse response) {
		...
		for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
			...
			try {
				List<CdIcbcBaseEntity> listCdIcbcBaseEntitys = 
					(List<CdIcbcBaseEntity>)ExcelImportUtil.importExcelByIs(file.getInputStream(),CdIcbcBaseEntity.class,params);
				for (CdIcbcBaseEntity cdIcbcBase : listCdIcbcBaseEntitys) {
					cdIcbcBaseService.save(cdIcbcBase);
				}
				j.setMsg("文件导入成功！");
			} catch (Exception e) {
