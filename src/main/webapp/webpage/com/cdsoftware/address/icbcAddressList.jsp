...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="icbcAddressList" checkbox="true" fitColumns="false" title="收货地址" actionUrl="icbcAddressController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="省份"  field="provinceId"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="城市"  field="cityId"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="区名"  field="orgId"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   ...
   <t:dgCol title="用户"  field="memberId"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
