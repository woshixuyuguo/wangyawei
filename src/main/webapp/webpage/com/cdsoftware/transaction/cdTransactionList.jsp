...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="cdTransactionList" checkbox="true" fitColumns="false" title="消费流水" actionUrl="cdTransactionController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="类型"  field="type"  hidden="true"  queryMode="single" dictionary="tramtype" width="120"></t:dgCol>
   <t:dgCol title="地点"  field="address"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
