...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="icbcProductController.do?doUpdate">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="originalPrice" name="originalPrice" type="text" style="width: 150px" class="inputxt"  
					                ...
					                value='${icbcProductPage.originalPrice}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				 <textarea id="describe" style="width:600px;" class="inputxt" rows="6" name="describe">${icbcProductPage.describe}</textarea>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="haveAddress" type="list"
						typeGroupCode="yesorno" defaultVal="${icbcProductPage.haveAddress}" hasLabel="false"  title="是否收货"></t:dictSelect>     
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					<t:dictSelect field="haveCode" type="list"
						typeGroupCode="yesorno" defaultVal="${icbcProductPage.haveCode}" hasLabel="false"  title="生成码"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="codeLength" name="codeLength" type="text" style="width: 150px" class="inputxt"  
					                ...
					                value='${icbcProductPage.codeLength}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="saleCount" name="saleCount" type="text" style="width: 150px" class="inputxt"  
					                ...
					                value='${icbcProductPage.saleCount}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	<t:dictSelect field="position" type="position"
						typeGroupCode="icbcCate"  hasLabel="false" defaultVal="${icbcProductPage.position}"  title="显示位置"></t:dictSelect>  
				<span class="Validform_checktip"></span>
			...
			<tr>
			<td align="right">
				<label class="Validform_label">主图:</label>
			</td>
			<td class="value">
		     	 <input id="img" name="img" type="text" style="width: 150px" class="inputxt"  
					                value='${icbcProductPage.img}'>
				<span class="Validform_checktip"></span>
				<label class="Validform_label" style="display: none;">主图</label>
			</td>
		</tr>
			<tr>
			<td align="right">
			...
			<td class="value">
			<t:ckeditor name="rule" isfinder="true" value="${icbcProductPage.rule}" type="width:750"></t:ckeditor>
		...
		<tr>
			...
			<td class="value">
			<t:ckeditor name="parameter" isfinder="true" value="${icbcProductPage.parameter}" type="width:750"></t:ckeditor>
								<%-- <script type="text/javascript"  charset="utf-8" src="plug-in/ueditor/ueditor.config.js"></script>
								<script type="text/javascript"  charset="utf-8" src="plug-in/ueditor/ueditor.all.min.js"></script>
						    	<textarea name="parameter" id="parameter" style="width: 650px;height:300px">${icbcProductPage.parameter}</textarea>
							    <script type="text/javascript">
			...
			<td class="value">
			<t:ckeditor name="service" isfinder="true" value="${icbcProductPage.service}" type="width:750"></t:ckeditor>
								<%-- <script type="text/javascript"  charset="utf-8" src="plug-in/ueditor/ueditor.config.js"></script>
								<script type="text/javascript"  charset="utf-8" src="plug-in/ueditor/ueditor.all.min.js"></script>
						    	<textarea name="service" id="service" style="width: 650px;height:300px">${icbcProductPage.service}</textarea>
							    <script type="text/javascript">
