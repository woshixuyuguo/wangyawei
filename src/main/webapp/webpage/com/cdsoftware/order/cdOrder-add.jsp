...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="cdOrderController.do?doAdd">
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="state" type="list"
						typeGroupCode="orderstate"  hasLabel="false"  title="状态"></t:dictSelect>     
				<span class="Validform_checktip"></span>
