...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="icbcCollectController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="productId" name="productId" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${icbcCollectPage.productId}'>
