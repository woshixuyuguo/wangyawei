 ...
 */
@Entity
@Table(name = "icbc_product_picture", schema = "")
@SuppressWarnings("serial")
public class IcbcProductPictureEntity implements java.io.Serializable {
	/**主键*/
