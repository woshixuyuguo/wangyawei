...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="cdMiniProgramController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="appSecret" name="appSecret" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
									                 value='${cdMiniProgramPage.appSecret}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="mchKey" name="mchKey" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
									                 value='${cdMiniProgramPage.mchKey}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="superManageAcount" name="superManageAcount" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
									                 value='${cdMiniProgramPage.superManageAcount}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="officialAccount" name="officialAccount" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
									                 value='${cdMiniProgramPage.officialAccount}'>
							<span class="Validform_checktip"></span>
